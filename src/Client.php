...
class Client
{
     ...
     * @param null $securityToken : securityToken from aliyun.com
     * @param Config|null $config : necessary configs
     */
     ...
     */
    public function getQueueRef(string $queueName, $base64 = true): Queue
    {
     ...
     */
    public function getTopicRef(string $topicName): Topic
    {
